...
public struct NumberTransformer<From, To: NumberConvertible>: FullTransformer {
...
extension Decimal: NumberConvertible {
    public static func fromNumber(_ number: NSNumber) -> Decimal {
        return Decimal(string: "\(number)", locale: Locale(identifier: "en_US")) ?? Decimal(0)
    }
